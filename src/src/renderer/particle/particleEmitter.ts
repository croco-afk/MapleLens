...
export class ParticleEmitter {
  ...
  randomColor(value: Color, range: Color) {
    ...
    return Color.shared.setValue([
      this.randomRangeUnit(baseColor[0] ?? 0, rangeColor[0] ?? 0),
      this.randomRangeUnit(baseColor[1] ?? 0, rangeColor[1] ?? 0),
      this.randomRangeUnit(baseColor[2] ?? 0, rangeColor[2] ?? 0),
      this.randomRangeUnit(baseColor[3] ?? 0, rangeColor[3] ?? 0),
    ]);
  }
